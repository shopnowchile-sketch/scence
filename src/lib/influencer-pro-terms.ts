export const INFLUENCER_PRO_TERMS = {
  ...
  sections: [
    ...
    { title: '9. Cancelación y cuenta', body: 'La influencer podrá solicitar la cancelación de su suscripción en cualquier momento. La solicitud de cancelación no afecta el período mensual ya pagado, que continuará vigente hasta su fecha de término. La cancelación de la autorización de pago producirá efectos respecto del período de pago siguiente, conforme a la normativa aplicable. SCENCE no realizará nuevos cobros una vez que la cancelación produzca efectos. La cancelación no elimina el historial de aceptaciones, documentos ni registros asociados. Desactivar la cuenta bloquea el acceso a SCENCE, pero tampoco elimina documentos ni registros históricos asociados.' },
