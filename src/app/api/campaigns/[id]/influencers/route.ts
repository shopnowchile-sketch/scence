...
export async function DELETE(request: NextRequest, { params }: Params) {
  ...
  if (relation) {
    ...
    // La papelera es una acción administrativa explícita: elimina la relación
    // para liberar el cupo y permitir que la influencer vuelva a postular.
    // El cierre automático por falta de confirmación usa PATCH/attendance_action,
    // no este DELETE.
