...
export const KPI_CATALOG: KpiDefinition[] = [
  ...
  { key: 'content.likes', label: 'Likes', category: 'content', unit: 'number', availability: 'available', description: 'Suma de likes verificados en publicaciones de la campaña.', dateField: 'campaign_deliverables.metrics_updated_at', filters: ['organization', 'date', 'brand', 'campaign', 'influencer', 'platform'] },
  { key: 'content.comments', label: 'Comentarios', category: 'content', unit: 'number', availability: 'available', description: 'Suma de comentarios verificados en publicaciones de la campaña.', dateField: 'campaign_deliverables.metrics_updated_at', filters: ['organization', 'date', 'brand', 'campaign', 'influencer', 'platform'] },
  ...
  { key: 'content.engagement_rate', label: 'Engagement', category: 'content', unit: 'percent', availability: 'available', description: 'Interacciones verificadas divididas por visualizaciones; se mantiene separada de la tasa histórica del perfil.', dateField: 'campaign_deliverables.metrics_updated_at', filters: ['organization', 'date', 'brand', 'campaign', 'influencer', 'platform'] },
  ...
  { key: 'affiliates.attributed_revenue', label: 'Ingresos por ventas', category: 'affiliates', unit: 'currency', availability: 'planned', description: 'Monto de ventas confirmadas atribuidas a la campaña o influencer.', dateField: 'affiliate_conversions.confirmed_at', filters: ['organization', 'date', 'brand', 'campaign', 'influencer'] },
