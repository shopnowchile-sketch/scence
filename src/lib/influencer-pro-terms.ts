export const INFLUENCER_PRO_TERMS = {
  ...
  version: '1.0',
  effectiveDate: '31 de agosto de 2026',
  sections: [
    { title: '1. Objeto del Plan Pro', body: 'El Plan Pro corresponde a una suscripción mensual que entrega acceso a funcionalidades, oportunidades y beneficios específicos dentro de SCENCE. El pago corresponde al acceso al plan y no constituye un pago por ser seleccionado, invitado o contratado para campañas, eventos o colaboraciones.' },
    { title: '2. Beneficios', body: 'El Plan Pro permite postular a eventos o campañas exclusivas disponibles para usuarios Pro, entrega prioridad para ser considerado en determinadas invitaciones públicas y puede habilitar invitaciones VIP. También pueden existir descuentos en campañas pagadas u otros beneficios, siempre sujetos a las condiciones particulares y disponibilidad de cada campaña.' },
    ...
    { title: '6. Campañas y compromisos', body: 'Cuando el Plan Pro se contrata desde una campaña, la suscripción puede quedar vinculada a esa campaña. La cancelación estará sujeta a que la campaña haya finalizado y a que todos los entregables obligatorios estén completos.' },
    { title: '7. Cancelación y cuenta', body: 'Cancelar la suscripción afecta su renovación y no elimina el historial de aceptaciones. Desactivar la cuenta bloquea el acceso a SCENCE, pero tampoco elimina documentos ni registros históricos asociados.' },
    { title: '8. Versionado', body: 'La aceptación queda asociada a esta versión. Si los términos cambian sustancialmente, SCENCE publicará una nueva versión y podrá requerir una nueva aceptación, conservando siempre el historial anterior.' },
  ],
} as const
