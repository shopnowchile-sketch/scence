// ── ENUMS ────────────────────────────────────────────────
export type UserRole = 'super_admin' | 'brand_manager' | 'member' | 'influencer' | 'finance'
export type CampaignStatus = 'draft' | 'pending_approval' | 'active' | 'paused' | 'completed' | 'canceled'
export type CampaignType = 'sponsored_post' | 'event_appearance' | 'ambassador' | 'product_seeding' | 'ugc' | 'live' | 'commission' | 'content_delivery'
