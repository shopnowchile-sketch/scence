...
export function BrandNewInfluencerForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Los seguidores se leen de Instagram al crearla (Meta). Si la cuenta es
      // personal o el @ no existe, queda marcada como no sincronizable.
      if (json.instagram_sync?.not_found) toast.success('Influencer agregada. Su Instagram no es sincronizable (cuenta personal o @ incorrecto).')
      else toast.success('Influencer agregada a tu roster')
