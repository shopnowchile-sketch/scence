export const INFLUENCER_PRO_TERMS = {
  ...
  sections: [
    ...
    { title: '9. Cancelación y cuenta', body: 'La influencer podrá solicitar la cancelación de su suscripción en cualquier momento, sin perjuicio de lo indicado en la sección 8. Una vez cancelada la suscripción, no se realizará la renovación ni un nuevo cobro por el período siguiente. La influencer mantendrá el acceso al Plan Pro hasta el término del período mensual ya pagado, cuya fecha se informa en Mi Perfil → Plan, conforme a la normativa aplicable. La cancelación no elimina el historial de aceptaciones, documentos ni registros asociados. Desactivar la cuenta bloquea el acceso a SCENCE, pero tampoco elimina documentos ni registros históricos asociados.' },
