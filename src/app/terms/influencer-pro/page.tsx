...
export default function InfluencerProTermsPage() {
  return <main className="min-h-screen bg-gray-50 px-4 py-10"><article data-no-translate className="mx-auto max-w-3xl rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-10">
