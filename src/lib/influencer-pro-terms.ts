export const INFLUENCER_PRO_TERMS = {
  ...
  version: '2.1',
  effectiveDate: '23 de septiembre de 2026',
  sections: [
    ...
    { title: '5. Suscripción y activación', body: 'La aceptación de estos términos no activa el Plan Pro. El plan se activa exclusivamente después de la confirmación válida de la suscripción y pago recurrente mediante PayPal. La facturación es mensual y la suscripción se mantiene activa durante cada período mensual pagado, sujeta a las condiciones de cancelación establecidas en estos términos.' },
    ...
    { title: '9. Cancelación y cuenta', body: 'La suscripción al Plan Pro puede ser cancelada por la influencer con al menos un mes de anticipación a la próxima fecha de renovación. Si la solicitud de cancelación se realiza con menos de un mes de anticipación a la próxima renovación, la cancelación no podrá aplicarse para dicho período de facturación y la suscripción continuará vigente durante el período correspondiente. Cuando la cancelación sea solicitada dentro del plazo establecido, el Plan Pro continuará activo hasta el término del período mensual ya pagado y no se realizará la renovación correspondiente al siguiente período. La cancelación no elimina el historial de aceptaciones, documentos ni registros asociados. Desactivar la cuenta bloquea el acceso a SCENCE, pero tampoco elimina documentos ni registros históricos asociados.' },
    { title: '10. Registro y acceso a los Términos y Condiciones', body: 'Cada aceptación de estos Términos y Condiciones quedará registrada en SCENCE asociada a la cuenta de la influencer, incluyendo la versión aceptada y la fecha y hora de aceptación. La influencer podrá consultar el registro de aceptación desde Mi Perfil → Documentos, donde estará disponible el documento correspondiente a la versión aceptada. La influencer podrá visualizar y descargar los Términos y Condiciones aceptados desde su perfil.' },
    { title: '11. Versionado', body: 'La aceptación queda asociada a esta versión. Debes aceptar la versión vigente de estos términos antes de tu próxima postulación a una campaña privada. Si los términos cambian sustancialmente, SCENCE publicará una nueva versión y podrá requerir una nueva aceptación, conservando siempre el historial anterior.' },
  ],
} as const
